...
const dict = {
  mr: {
    ...
    setup_intro_username: 'हे फक्त एक सुचवलेले नाव आहे. लक्षात राहील असे दुसरे नाव तुम्ही ठेवू शकता.',
    setup_username: 'तुमचे वापरकर्तानाव निवडा',
    setup_username_hint: 'फक्त इंग्रजी लहान अक्षरे, अंक, _ आणि - , 3 ते 32 अक्षरे. लॉग इन करताना हेच नाव टाइप करावे लागेल.',
    setup_username_checking: 'तपासत आहे...',
    setup_username_available: 'हे नाव उपलब्ध आहे',
    setup_username_taken: 'हे नाव आधीच वापरात आहे. दुसरे निवडा.',
    setup_username_reserved: 'हे नाव राखीव आहे. दुसरे निवडा.',
    setup_username_format: 'नाव इंग्रजी लहान अक्षराने सुरू करा, त्यानंतर फक्त लहान अक्षरे, अंक, _ किंवा - , 3 ते 32 अक्षरे.',
  ...
  hi: {
    ...
    setup_intro_username: 'यह केवल एक सुझाव है. आप इसे बदलकर कोई ऐसा नाम रख सकते हैं जो आपको याद रहे.',
    setup_username: 'अपना उपयोगकर्ता नाम चुनें',
    setup_username_hint: 'केवल अंग्रेज़ी के छोटे अक्षर, अंक, _ और - , 3 से 32 अक्षर. लॉग इन करते समय यही नाम टाइप करना होगा.',
    setup_username_checking: 'जाँच की जा रही है...',
    setup_username_available: 'यह नाम उपलब्ध है',
    setup_username_taken: 'यह नाम पहले से इस्तेमाल में है. कोई दूसरा चुनें.',
    setup_username_reserved: 'यह नाम आरक्षित है. कोई दूसरा चुनें.',
    setup_username_format: 'नाम अंग्रेज़ी के छोटे अक्षर से शुरू करें, उसके बाद केवल छोटे अक्षर, अंक, _ या - , 3 से 32 अक्षर.',
  ...
  en: {
    ...
    setup_intro_username: 'That is only a suggestion. Replace it with a name you will remember.',
    setup_username: 'Choose your username',
    setup_username_hint: 'Lowercase letters, digits, _ and - only, 3 to 32 characters. This is what you will type to log in.',
    setup_username_checking: 'Checking…',
    setup_username_available: 'That username is available',
    setup_username_taken: 'That username is already taken. Please pick another.',
    setup_username_reserved: 'That username is reserved. Please pick another.',
    setup_username_format: 'Start with a lowercase letter, then lowercase letters, digits, _ or - only, 3 to 32 characters.',
